...
class Discrete_Building_Env(gym.Env):
    """
    ...
    def __init__(self, grid_size = np.array([42,120])):
        super(Discrete_Building_Env, self).__init__()
        ...
        self.action_space = spaces.MultiDiscrete([self.grid_size[0],self.grid_size[1],5,5])
    ...
    def step(self, action):
        ...
        self.state[self.count-1, 0] = action[0]
        self.state[self.count-1, 1] = action[1]
        ...
        self.state[self.count-1, 2] = ((action[2]-2)/2)*((self.limit[self.count][1]-self.limit[self.count][0])/2)\
                                    + ((self.limit[self.count][0]+self.limit[self.count][1])/2)
        self.state[self.count-1, 3] = ((action[3]-2)/2)*((self.limit[self.count][3]-self.limit[self.count][2])/2)\
